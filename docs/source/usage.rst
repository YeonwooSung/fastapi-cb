...
Using a :class:`~fastapi_cb.circuitbreaker.CircuitBreaker`
...
Another option is the :func:`~fastapi_cb.circuitbreaker.CircuitBreaker.call`
or :func:`~fastapi_cb.circuitbreaker.CircuitBreaker.call_async`
...
:func:`~fastapi_cb.circuitbreaker.CircuitBreaker.__call__`.

Manually Setting Or Resetting The Circuit
=========================================

The circuit can be manually opened or closed if needed.
:func:`~fastapi_cb.circuitbreaker.CircuitBreaker.open` will open
the circuit causing subsequent calls to fail until the
:attr:`~fastapi_cb.circuitbreaker.CircuitBreaker.timeout_duration`
elapses. Similarly, :func:`~fastapi_cb.circuitbreaker.CircuitBreaker.close`
...
:class:`~fastapi_cb.listener.CircuitBreakerListener` class.

.. code:: python

    from fastapi_cb import CircuitBreaker, CircuitBreakerListener
...
:func:`~fastapi_cb.circuitbreaker.CircuitBreaker.add_listener` and
:func:`~fastapi_cb.circuitbreaker.CircuitBreaker.remove_listener`
functions.
...
:func:`~fastapi_cb.circuitbreaker.CircuitBreaker.add_excluded_exception` and
:func:`~fastapi_cb.circuitbreaker.CircuitBreaker.remove_excluded_exception`
functions.
